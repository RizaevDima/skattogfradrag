var app = {
    ...
    renderHomeView: function() {
        ...
        var html =
                ...
                "<div class='camera_options select_photo'><div class='img_camera'><img src='img/settings_img.png' alt='Plus'></div><p>REGISTRER POSTER</p></div>" +
    ...
    renderPlanView: function() {
        ...
        xhr.onload = function(){
            ...
            if (user_plan_type == "traveling-plan") {
                ...
                var globalPlanData = response.message[last_travelind_id];
                addNewTravelHtml += '<button type="button" class="btn_general add-new-travel-btn">Oprett ny reiseregning</button>';
            } else {
                var globalPlanData = response.message;
            }
            ...
            if (response.status == '404') {
                ...
                var html =
                        ...
                        "<div class='document "+planVariation+"'><form method='post' id='save_user_options_value'><p>Registrer poster</p>" + html_options + "</form></div>" +show_save_btn+
                        ...
                        "<div class='modal custom fade in' id='add-new-travel-modal' aria-hidden='false' aria-labelledby='calculate_modal-label' role='dialog' tabindex='-1'>" +
                            "<div class='modal-dialog'>" +
                                "<div class='modal-content'>" +
                                    "<div class='modal-body'>" +
                                        "<div class='btl-formcontact'>" +
                                            "<p class='modal-window-title'>Oprett ny reiseregning:</p>" +
